...
- (1.08674 g)(.951519 pure) = 0.972 g/hr pure PGDN
- (0.972)(24)(365) = 8514.72 g/yr pure PGDN = 51.26 mol/yr
- $ 354.41 per year of 1,2-Propanediol
- $ 1637.63 per year of KNO3 
- Total: $1992.04 per year or 0.23 $ /hr

##### Net Present Value Calculation

Initial Investment = $ 1680

Money saved per year: 1992.04 - 1035.09 = $ 956.95

For 1% depreciation rate, in two years the NPV will be ($ -1680) + ($ 956.95)(0.99) + ($ 956.95)(0.99)(0.99) = 205.29 > 0, which means in two years the project will be financially sustainable.

For 10% depreciation rate, in three years the NPV will be ($ -1680) + ($ 956.95)(.9) + ($ 956.95)*(.9)*(0.9) + ($ 956.95)*(.9)*(0.9)*(0.9) = 654.00 > 0, which means in three years the project will be financially sustainable.
"""
...
md"""
### Conclusions
The client’s idea of creating PGDN with sucrose is financially sustainable only if the client is willing to run the reactor for more than three years (NPV becomes positive starting in the third year). Therefore, if the client is just looking to get PGDN quickly, it is more financially efficient to buy the chemicals directly from SigmaAldrich.
"""
